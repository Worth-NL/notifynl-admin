...
2. **Document download and email template attachments** — are these a priority for this sync, or do we track them as separate follow-up work? They're the two large features still missing.
