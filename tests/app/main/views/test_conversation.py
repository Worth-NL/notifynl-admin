...
def test_view_conversation(
    ...
    assert (
        ...
        == "Text message conversation with 07123 456789 – service one – GOV.UK Notify"
    )
    assert normalize_spaces(page.select_one("h1").text) == "Text message conversation with 07123 456789"
