...
from app.main.overrides_nl.forms import LoginForm
...
def sign_in():
    ...
    if form.validate_on_submit():
            ...
            if user.is_active:
                if session.get("invited_user_id"):
                    ...
                    if user.email_address.lower() != invited_user.email_address.lower():
                        flash("U kunt geen uitnodiging voor iemand anders accepteren.")
        ...
        flash(
            Markup(
                f"Het e-mailadres of wachtwoord dat u heeft ingevoerd is onjuist."
