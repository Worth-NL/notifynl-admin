...
def init_performance_monitoring():
    ...
    if environment and sentry_enabled and sentry_dsn:
        ...
        sentry_sdk.init(
            ...
            enable_logs=True,
            release=release,
            # Explicit so S3 writes (logos, CSVs, letter uploads via app/s3_client/) show
            # up as spans -- this repo has no Celery here, so no CeleryIntegration to pair it with.
